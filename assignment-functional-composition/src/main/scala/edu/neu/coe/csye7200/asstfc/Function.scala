...
object Function {
  ...
  /**
    ...
    */
  def map2[T1, T2, R](t1y: Try[T1], t2y: Try[T2])(f: (T1, T2) => R): Try[R] = t1y flatMap (a => t2y map (b => f(a, b))) // TO BE IMPLEMENTED
  ...
  /**
    ...
    * @return a value of R, wrapped in Try
    */
  def map3[T1, T2, T3, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3])(f: (T1, T2, T3) => R): Try[R] = t1y flatMap (a => t2y flatMap (b => t3y map (c => f(a, b, c)))) // TO BE IMPLEMENTED

  /**
    * You get the idea...
    */
  def map7[T1, T2, T3, T4, T5, T6, T7, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3], t4y: Try[T4], t5y: Try[T5], t6y: Try[T6], t7y: Try[T7])
                                         (f: (T1, T2, T3, T4, T5, T6, T7) => R): Try[R] = for (a <- t1y; b <- t2y; c <- t3y; d <- t4y; e <- t5y; g <- t6y; h <- t7y) yield f(a, b, c, d, e, g, h)
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (a: T1, b: T2) => f(a)(b) // TO BE IMPLEMENTED
  ...
  def uncurried3[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): (T1, T2, T3) => T4 => R = (a: T1, b: T2, c: T3) => f(a)(b)(c) // TO BE IMPLEMENTED
  ...
  def uncurried7[T1, T2, T3, T4, T5, T6, T7, T8, R](f: T1 => T2 => T3 => T4 => T5 => T6 => T7 => T8 => R): (T1, T2, T3, T4, T5, T6, T7) => T8 => R =
    (a: T1, b: T2, c: T3, d: T4, e: T5, g: T6, h: T7) => f(a)(b)(c)(d)(e)(g)(h) // TO BE IMPLEMENTED
